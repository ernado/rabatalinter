...
// isGeneratedFile checks if the file contains the standard Go generated code comment.
func isGeneratedFile(f *ast.File) bool {
	for _, commentGroup := range f.Comments {
		for _, comment := range commentGroup.List {
			if strings.Contains(comment.Text, "Code generated by") && strings.Contains(comment.Text, "DO NOT EDIT") {
				return true
			}
			if strings.Contains(comment.Text, "code generated by") && strings.Contains(comment.Text, "DO NOT EDIT") {
				return true
